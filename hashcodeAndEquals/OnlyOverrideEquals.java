...
public class OnlyOverrideEquals {
    ...
    public static void main(String[] args) {
        ...
        // make a hashmap to check sideeffect of overriding equals
        Map<Student, Integer> map = new HashMap<>();
        map.put(s1, 1); // goes in diff bucket
        map.put(s2, 2); // goes in diff bucket
        // expectation -  as s1 and s2 have same roll nos, they must go in same bucket in hashMap, and s2 must override s1
        // but as u didnt override hashCode, diff buckets are created for both s1 and s2, and neither of them will override anyone
