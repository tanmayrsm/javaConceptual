...
// tutors example java program -
// program to calculate throughput and latency
public class producer_consumer_eg implements PerformanceJMX {
    ...
    public static void main(String[] args) {
        producer_consumer_eg main = new producer_consumer_eg();
        main.start();
    }
